...
function QR() {
    ...
    return (
        <div className="flex flex-col items-center justify-center sm:h-[75px] bg-gray-100 dark:bg-gray-800 : bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
            {showInstructions ? (
