...
function QR() {
    ...
    useEffect(() => {
        const generatedUrl = "https://www.libroredsocial.com/guest-info";
    ...
    return (
        <div className="flex flex-col items-center justify-center bg-gray-100 dark:bg-gray-900 : bg-white dark:bg-gray-900 text-gray-900 dark:text-white">
            {showInstructions ? (
